...
local language = {
    ["eng"] = {
        welcome = "{\\fs24\\1c&HF5D3C8&\\3c&H30201E&}Drop files or URLs to play here.",  -- this text appears when mpv starts
        off = "Off",
        unknown = "unknown",
        none = "none",
    ...
    ["chs"] = {
        welcome = "{\\1c&HF5D3C8\\bord0\\fs30\\fn微软雅黑 light\\fscx125}MPV{\\fscx100} 播放器",  -- this text appears when mpv starts
        off = "关闭",
        na = "n/a",
        none = "无",
        video = "视频",
...
local osc_styles = {
    box = "{\\blur100\\bord0\\1c&H30201E\\3c&H30201E}",
    seekbar_bg = "{\\blur0\\bord0\\1c&H61423B}",
    seekbar_fg = "{\\blur0\\bord0\\1c&HFFAA82}",
    volumebar_bg = "{\\blur0\\bord0\\1c&H61423B}",
    volumebar_fg = "{\\blur0\\bord0\\1c&HFF99C0}",
    button = "{\\blur0\\bord0\\1c&HF5D3C8\\3c&HF5D3C8}",
    timecode = "{\\blur0\\bord0\\1c&HF5D3C8\\3c&H000000\\fs18}",
    tooltip = "{\\blur1.5\\bord0.01\\1c&HF5D3C8\\3c&H30201E\\fs18}",
    title = "{\\1c&HF5D3C8\\fs24}",
}
...
function show_logo()
    ...
    ass:append('{\\1c&HFF99C0&\\3c&H0&\\3a&H60&\\blur1\\bord0.5}')
    ass:draw_start()
