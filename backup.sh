...
PAIRS=(
  ...
  "$HOME/.local/share/plasma/look-and-feel|.local/share/plasma/look-and-feel"
  "$HOME/.local/share/plasma/plasmoids|.local/share/plasma/plasmoids"
  "$HOME/.local/share/plasma/wallpapers|.local/share/plasma/wallpapers"
  ...
  "$HOME/.config/kwinrc|.config/kwinrc"
  "$HOME/.config/kwinrulesrc|.config/kwinrulesrc"
  "$HOME/.config/plasma-org.kde.plasma.desktop-appletsrc|.config/plasma-org.kde.plasma.desktop-appletsrc"
  "$HOME/.config/plasmashellrc|.config/plasmashellrc"
  "$HOME/.config/plasmarc|.config/plasmarc"
  "$HOME/.config/kscreenlockerrc|.config/kscreenlockerrc"
  "$HOME/.config/ksplashrc|.config/ksplashrc"
  "$HOME/.config/kcmfonts|.config/kcmfonts"
)
